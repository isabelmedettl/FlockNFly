...
AFlockNFlyCharacter::AFlockNFlyCharacter()
{
...
void AFlockNFlyCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AFlockNFlyCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AFlockNFlyCharacter::Move);
...
void AFlockNFlyCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
